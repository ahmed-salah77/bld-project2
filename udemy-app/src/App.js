...
import SingleCourseFetching from "./singleCourseFetching";
import CourseContentFetching from "./courseContentFetching";
...
function App() {
  ...
  useEffect(() => {
    ...
    let uri =
      "https://www.udemy.com/api-2.0/courses/" +
      courseId +
      "/public-curriculum-items/?fields[chapter]=@all&fields[lecture]=@all&page_size=500";
    let h = new Headers();
    h.append("Accept", "application/json, text/plain, */*");
    h.append(
      "Authorization",
  ...
  return (
    <CourseData.Provider
      value={{ courses, setSearchText, singleCourse, setCourseId,courseContent }}
    >
      <Routes>
